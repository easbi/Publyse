...
@section('content')
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        {{-- Menampilkan pesan sukses setelah aksi (misal: tambah publikasi) --}}
        @if (session('success'))
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-semibold">Publikasi yang Saya Buat</h3>
                         {{-- Tombol ini akan selalu tampil untuk semua user, tapi bisa juga dibatasi dengan Gate jika perlu --}}
                        <a href="{{ route('publications.create') }}" class="px-3 py-1 bg-green-500 text-white text-xs font-bold rounded-md hover:bg-green-600">+ Tambah</a>
                    </div>
                    <div class="space-y-4">
                        @forelse ($myCreations as $publication)
                            <div class="p-4 border rounded-lg dark:border-gray-700">
                                ...
                                <div class="mt-3 flex gap-2">
                                    ...
                                    {{-- Tombol "Review" hanya muncul jika user boleh 'melihat' publikasi --}}
                    ...
                    <div class="space-y-4">
                        @forelse ($myAssignments as $publication)
                            <div class="p-4 border rounded-lg dark:border-gray-700">
                                ...
                                <div class="mt-3">
                                    <a href="{{ route('publications.summary', $publication) }}" class="px-3 py-1 bg-gray-500 text-white text-xs rounded-md hover:bg-gray-600">Ringkasan</a>
                                    {{-- Tombol ini akan selalu bisa diakses karena ini adalah tugas user --}}
