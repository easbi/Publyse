...
<div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title">Input Publikasi</h3>
    </div>
</div>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <form action="{{ route('publikasi.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-lg mb-3" name="batas_upload" required>
                                </div>
                                <div class="form-group">
                                    <label for="waktu_rilis">Waktu Rilis</label>
                                    <input type="date" class="form-control form-control-lg mb-3" name="waktu_rilis" required>
                                </div>
                                <div class="form-group">
                                    <label for="batas_pemeriksaan">Batas Pemeriksaan</label>
                                    <input type="date" class="form-control form-control-lg mb-3" name="batas_pemeriksaan" required>
                                </div>
                                <div class="form-group">
                                    <label for="batas_tl">Batas Tindak Lanjut</label>
                                    <input type="date" class="form-control form-control-lg mb-3" name="batas_tl" required>
                                </div>
                                <div class="form-group">
